...
class TemperatureReadings:
    ...
    def get_average(self):
        temp_sum = sum(self.temp_readings)
        average = temp_sum / len(self.temp_readings)
        return average
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"T:{self.getFahrenheit():0.1f}F AVG:{avg_temp:0.1f}F"
                ...
                lcd_line_2 = f"MN:{min_temp:0.1f}F MX:{max_temp:0.1f}F"
